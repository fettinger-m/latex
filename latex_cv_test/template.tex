...
\setmainfont{STIX Two Text} % Main document font
...
\par{\centering{\Huge Maximilian \textsc{Fettinger}}\bigskip\par} % Your name
...
\begin{tabular}{rl}
\textsc{Nov.} 2022 & Merit scholarship to recognise outstanding academic achievements\normalsize\\
\end{tabular}
...
\begin{tabular}{rl}
Basic Knowledge: & C, Julia, Mathemathica, MS Office, Vue.js, JavaScript, SQL, Swift, Illustrator\\

Intermediate Knowledge: & Python, SymPy, NumPy, Java, Photoshop\\
\end{tabular}
